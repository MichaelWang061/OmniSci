...
def addUser():
    name_list = ['wangkexiang', 'baiyong', 'xiafeiyu', 'qinziwei', 'xuxiangrong', 'renhouxing','wangtianyi']
    password_list = ['WangKX1606', 'BaiY1606', 'XiaFY1606', 'QinZW1606', 'XuXR1606', 'RenHX1606','WangTY1606']
    for i in range(31):
        if i < 7:
            name = name_list[i]
